        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="flex items-center">
            ...
            <label htmlFor="marketingConsent" className="ml-2 block text-sm text-gray-600">
              I agree to receive marketing communications from Goldthorn Collective. 
              <Link href="/marketing-consent" className="text-blue-600 hover:text-blue-500 ml-1">
                Learn more
              </Link>
            </label>
          </div>
          ...
          <div className="flex items-center">
            <input
              ...
              onChange={handleChange}
            />
            <label htmlFor="termsConsent" className="ml-2 block text-sm text-gray-600">
